...
def make_sequential_search_agent(
    ...
    *,
    ...
    model_settings_kwargs = {"max_tokens": 4096}
    ...
    return Agent[Any](
        ...
        instructions=(
            ...
            "2. **Plan Your Research**: If complex, break down the query into logical search components or related topics.\n"
            "3. **Execute Searches**: Use the websearch tool to gather information. You can perform multiple searches to:\n"
            ...
            "Examples of when to use multiple searches:\n"
